...
class IncepConv(nn.Module):
    def __init__(self, input_dim, output_dim):
        ...
        self.branch1 = nn.Sequential(nn.Conv2d(input_dim, output_dim, kernel_size=1, stride=1, bias=True),
                                     nn.InstanceNorm2d(output_dim),
                                     nn.LeakyReLU(0.01, inplace=True),
                                     )

        self.branch3 = nn.Sequential(nn.Conv2d(input_dim, input_dim, kernel_size=1, stride=1, bias=True),
        ...
        self.branch5 = nn.Sequential(nn.Conv2d(input_dim, output_dim, kernel_size=1, stride=1, bias=True),
                                     nn.InstanceNorm2d(output_dim),
                                     nn.LeakyReLU(0.01, inplace=True),
                                     nn.Conv2d(output_dim, output_dim, kernel_size=5, stride=1, padding=2, bias=True),
                                     nn.InstanceNorm2d(output_dim),
                                     nn.LeakyReLU(0.01, inplace=True),
                                     )
        ...
        self.out = nn.Sequential(nn.Conv2d(4*output_dim, output_dim, kernel_size=1, stride=1, bias=True),
                                  nn.InstanceNorm2d(output_dim),
                                  nn.LeakyReLU(0.01, inplace=True),
                                  )
